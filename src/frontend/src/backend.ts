...
export class Backend implements backendInterface {
    ...
    async getConfirmedInquiries(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getConfirmedInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDeletedInquiries(): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDeletedInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markInquiryAsConfirmed(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markInquiryAsConfirmed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markInquiryAsDeleted(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markInquiryAsDeleted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAndContinueOnWhatsApp(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<{
        id: bigint;
        timestamp: Time;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAndContinueOnWhatsApp(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<{
        id: bigint;
        timestamp: Time;
    }> {
        if (this.processError) {
